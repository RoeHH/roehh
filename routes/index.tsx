...
> = {
  async GET(req: Request, ctx) {
    if(ctx.state.user){
      ...
      if(url.searchParams.has("date") && url.searchParams.has("title") && url.searchParams.has("description1") && url.searchParams.has("description2")){
    ...
    <>
      ...
      <header>
        ...
        <section>
          <div class="about">
            ...
            <iframe style="border-radius:12px; margin: auto;" src="https://open.spotify.com/embed/playlist/37i9dQZF1EphN67AaXPTwX?utm_source=generator&theme=0" width="100%" height="152" frameBorder="0" allowfullscreen="true" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>
      ...
      {data.user ? (
        <form action="/" method="get" class="card card-edit">
          <header class="card-header">
            <h3>
              <input type="text" placeholder="Month/Date" name="date"></input>
            </h3>
            <h2>
          ...
          <p>
            <textarea name="description1" placeholder="Short description" rows={2} cols={30}>
            </textarea>
          </p>
          <p>
            <textarea name="description2" placeholder="Project journey description" rows={4} cols={30}>
            </textarea>
          </p>
          <p>
            Repository:
